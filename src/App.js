...
class Main extends Component {
    ...
    return (
      <div className="row bg-dark">
          <button type="button" className="btn btn-dark btn-lg col-lg"><Link to="/">Se géolocaliser </Link></button>
          ...
          <button type="button" className="btn btn-dark btn-lg col-lg"><Link to="/bars"> Trouver un bars </Link></button>
    ...
    return (
      <BrowserRouter>
        <div style={{ background: '#dceafd', width: '100vw', height: '100vh' }}>
          ...
          <div style={{ height: '100vh', paddingTop: '5vh'}}>
